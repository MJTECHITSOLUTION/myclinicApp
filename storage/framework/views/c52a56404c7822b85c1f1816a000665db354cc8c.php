...
<?php $__env->startSection('footer'); ?>
    ...
    <script type="text/template" id="drugs_labels">
        <section class="field-group">
            <div class="field-group row">
                <div class="col-md-12">
                    <select class="form-control rounded-0 shoadow-none shadow-none rounded-0 multiselect-drugs_cat"
                            name="drugs_cat" id="drugs_cat">
                        <option value="">Sélectionner type</option>
    ...
    <script>
        ...
        $("#acteTable").on("dblclick", "td.editable-libelle", function () {
            ...
            inputField.blur(function () {
                var newValue = inputField.val();
                cell.html(newValue);
                var hiddenInput = cell.closest("tr").find("input[name='libelle_actt[]']");
                hiddenInput.val(newValue);
            });
        });
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\MAMP\htdocs\MYCLINIC-PEDIATRE\resources\views/prescription/specialty/dentiste/edit.blade.php ENDPATH**/ ?>