        ...
        <div class="col-10">
            <div class="card shadow mb-4">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col" >
                            <img src="<?php echo e(asset("img/Malaklogo.png")); ?>" height="250px;"><br><br>
                    ...
                    <div class="row justify-content-center">
                        <div class="col">
                            <h5 class="text-center mt-5" style="font-size: xx-large"><b>Note d'honoraire</b></h5>
                            <br><br>
                            <table class="table">
    ...
    <div id="print_area" style="display: none;">
        ...
        <div class="row justify-content-center">
            <div class="col">
                ...
                <h5 class="text-center mt-5" style="font-size: xxx-large"><b>Note d'honoraire</b></h5>
                <br><br>
