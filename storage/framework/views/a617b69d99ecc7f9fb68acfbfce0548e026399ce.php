            ...
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create appointment')): ?>
                        ...
                        <form action="<?php echo e(route('appointment.destroyWaitingList')); ?>" method="POST" class="float-right ml-2 mb-1" onsubmit="event.preventDefault(); Swal.fire({
                            title: 'Êtes-vous sûr?',
                    ...
                    <form action="<?php echo e(route('appointment.searchByDate')); ?>" method="GET" class="float-right ml-2 mb-1 d-flex align-items-center">
                        <input type="date" name="date" class="form-control form-control-sm d-inline-block" required>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <?php if($appointment->active): ?>
                                    <a href="#" onclick="printValue('<?php echo e($appointment->num); ?>')" title="Imprimer" style="margin-left: 10px;">
                            ...
                            <td class="text-center">
                                ...
                                <a class="editAppointmentButton" 
                                data-rdv_id="<?php echo e($appointment->appointment_id); ?>"
                                data-patient_name="<?php echo e($appointment->User->name); ?>"
                                data-waiting_list_id="<?php echo e($appointment->id); ?>"
                                class="btn rounded-0 btn-outline-success btn-circle btn-sm" 
                                data-toggle="modal" data-target="#EDITRDVModal">
                                    <i class="fas fa-edit rounded-circle"></i>
                                </a>
                                <span style="margin: 0 5px;"></span> <!-- Space between icons -->
                                <a href="#" class="btn btn-danger btn-circle btn-sm" data-toggle="modal" data-target="#DeleteModal" data-link="<?php echo e(url('appointment/delete/' . $appointment->id)); ?>" title="Delete">
                                    <i class="fas fa-trash"></i>
                                </a>
                                <span style="margin: 0 5px;"></span> <!-- Space between icons -->
                                <label class="switchA" style="margin-left: 10px;">
                                    <input type="checkbox" 
                                           onclick="toggleActive(this, <?php echo e($appointment->id); ?>);" 
                                           <?php echo e($appointment->active ? 'checked' : ''); ?>>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="rdv-form-confirm" action="<?php echo e(route('appointment.store_edit')); ?>" method="POST"
                          class="d-none">
                        <input type="hidden" name="wating_list_id" id="waiting_list_id">
                    ...
                    <form id="rdv-form-salle" action="<?php echo e(route('appointment.store_edit')); ?>" method="POST"
                        ...
                        <input type="text" name="wating_list_id" id="waiting_list_id">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\myclinicApp\resources\views/appointment/pending.blade.php ENDPATH**/ ?>