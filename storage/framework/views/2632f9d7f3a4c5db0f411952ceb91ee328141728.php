        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapserapport" class="collapse" aria-labelledby="headingPages"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view all drugs')): ?>
                            <a class="collapse-item" href="<?php echo e(route('gabarit.all')); ?>">Rapport patient </a>
                        <?php endif; ?>
                           <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view all drugs')): ?>
                    ...
                    <div id="collapseAppointment" class="collapse" aria-labelledby="headingTwo"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view all appointments')): ?>
                                ...
                                <a class="collapse-item"
                                   href="<?php echo e(route('appointment.day')); ?>"><?php echo e(__('sentence.All Appointments')); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseSettings" class="collapse" aria-labelledby="headingPages"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <div class="dropdown" >
                                <a class="collapse-item dropdown-toggle" href="#" id="nestedDropdownMessages" role="button"
                                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Messages
                                </a>
                                <div class="dropdown-menu" aria-labelledby="nestedDropdownMessages">
                                        <a class="collapse-item"
                                           href="<?php echo e(route('notifies.index')); ?>">Créer un message</a>
                                        <a class="collapse-item"
                                           href="<?php echo e(route('notifies.index')); ?>">Tous les messages</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="notificationCard" class="card" style="display: none; position: fixed; bottom: 70px; right: 20px; width: 300px;">
                <div class="card-body">
                    ...
                    <?php if($salle_soins->isNotEmpty()): ?> <!-- Check if there are any results -->
                        <?php $__currentLoopData = $salle_soins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salle_soin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <!-- Loop through each result -->
                            <div class="header_notification d-flex align-items-center notification-wrapper" style="background-color: #f0f0f0; border-radius: 10px; padding: 10px; margin-bottom: 5px;">
                                <div class="notification_icon me-2">
                                    <img src="<?php echo e(asset('img/thumbnail.png')); ?>" class="img-fluid my_img_profil rounded-circle" alt="user" style="max-width: 30px;">
                                </div>
                                <p class="notification_text mb-0" style="margin-left: 10px;">
                                    <a href="<?php echo e(url('patient/view/'.$salle_soin->user_id)); ?>" class="text-decoration-none text-dark" role="button">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="dropdown shortcut-menu mr-4">
                        <button type="button" class="btn btn-doctorino brd-20 dropdown-toggle" data-toggle="dropdown"
                                aria-expanded="false">Accès rapide
                             </button>
                        <div class="dropdown-menu shadow">
                            ...
                            <?php if(Auth::user()->can('create appointment')): ?>
                            <a class="dropdown-item"
                               href="<?php echo e(route('appointment.pending')); ?>">Salle d'attent</a>
                        <?php endif; ?>
                    ...
                    <ul class="navbar-nav ml-auto">
                        <?php if(empty(!$lastPatientId)): ?>
                            <div class="d-flex align-items-center flex-wrap">
                                <a href="<?php echo e(url('patient/view/'.$lastPatientId)); ?>" class="d-flex align-items-center text-decoration-none mr-3 mb-2 mb-md-0">
                                    <?php if($genderPation == 'Homme' || $genderPation == 'Boy'): ?>
                                        <img src="<?php echo e(asset('img/homme.png')); ?>" class="rounded-circle" width="50" height="50" alt="Profile">
                                    <?php elseif($genderPation == 'Femme' || $genderPation == 'Female'): ?> 
                                        <img src="<?php echo e(asset('img/femme.png')); ?>" class="rounded-circle" width="50" height="50" alt="Profile">
                                    <?php elseif($genderPation == 'Enfant' || $genderPation == 'Garçon'): ?>
                                        <img src="<?php echo e(asset('img/garson.png')); ?>" class="rounded-circle" width="50" height="50" alt="Profile">
                                    <?php elseif($genderPation == 'Fille' || $genderPation == 'fille'): ?>
                                        <img src="<?php echo e(asset('img/fille.png')); ?>" class="rounded-circle" width="50" height="50" alt="Profile">
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('img/homme.png')); ?>" class="rounded-circle" width="50" height="50" alt="Profile">
                                    <?php endif; ?>
                                    <span class="ml-2"><?php echo e($namePatient); ?></span>
                                </a>
                                
                                <a class="fa fa-user-times fa-1x text-danger ml-2" href="<?php echo e(route('clear.session')); ?>" aria-hidden="true"></a>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="d-flex align-items-center ml-auto">
                            <div class="dropdown mr-3">
                                ...
                                <div class="dropdown-menu dropdown-menu-right p-3" aria-labelledby="notifyDropdown" style="min-width: 300px;">
                                    <div class="predefined-messages mb-3">
                                        <?php $__currentLoopData = App\Notify::where('actif', 1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notify): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <form action="<?php echo e(route('send.notify')); ?>" method="get">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="message" value="<?php echo e($notify->name); ?>">
                                                <button type="submit" class="btn btn-outline-primary btn-sm mb-2 w-100"><?php echo e($notify->name); ?></button>
                                            </form>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <div class="dropdown-divider"></div>
                                    <form action="<?php echo e(route('send.notify')); ?>" method="get" class="d-flex align-items-center">
                                        <?php echo csrf_field(); ?>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <img class="img-profile rounded-circle" src="<?php echo e(asset('img/favicon.png')); ?>" alt="Profile">
                                </a>
...
<?php /**PATH C:\MAMP\htdocs\myclinicApp\resources\views/layouts/specialty/generalist/master.blade.php ENDPATH**/ ?>