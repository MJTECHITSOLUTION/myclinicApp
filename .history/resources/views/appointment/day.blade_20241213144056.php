    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                ...
                <div class="col-3">
                    <form action="{{ route('dayfilter.search') }}" method="get" class="form-inline my-2 my-lg-0">
                        <div class="input-group mb-3"> <!-- Wrap input and button within input-group -->
                            <input type="date" class="form-control" name="datefilter" placeholder="{{ __('sentence.Select Date') }}" aria-label="{{ __('sentence.Select Date') }}">
                            <select class="form-control mx-2" name="statusfilter" aria-label="{{ __('sentence.Select Status') }}">
                                <option value="">{{ __('sentence.All Statuses') }}</option>
                                <option value="1">{{ __('sentence.Terminé') }}</option>
                                <option value="3">{{ __('sentence.Salle d\'attente') }}</option>
                            </select>
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="submit" title="{{ __('sentence.Search') }}">
