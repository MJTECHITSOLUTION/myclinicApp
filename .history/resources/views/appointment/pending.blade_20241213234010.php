            ...
            <div class="row">
                ...
                <div class="col-8">
                    @can('create appointment')
                        ...
                        <!-- Button to delete all Waiting_list entries -->
                        <form action="{{ route('appointment.destroyWaiting', ['id' => 'all']) }}" method="POST" class="float-right ml-2 mb-1">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn rounded-0 btn-danger btn-sm" title="Delete All">
                                <i class="fa fa-trash"></i> <span class="d-none d-lg-inline-block">Supprimer tout</span>
                            </button>
                        </form>
