...
@section('header')
    ...
    function printValue(num) {
        ...
        printWindow.document.write('<h3 style="text-align:center">Numéro de paiement</h3>');
        printWindow.document.write('<h1 style="text-align:center">' + num + '</h1>');
        printWindow.document.write('<p style="font-size:small;">Docteur : ' + doctor + '<br>');
        printWindow.document.write('Adresse : ' + address + ', ' + city + ', ' + phone + '.</p>');
        printWindow.document.write('<p style="font-size:small;">Merci pour votre paiement.</p>');
