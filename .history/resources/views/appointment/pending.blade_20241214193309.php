...
function toggleActive(checkbox, appointmentId) {
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                Swal.fire("Statut mis à jour avec succès."); // Notify user of success
            <button class="btn btn-refresh" onclick="location.reload();" title="Refresh Page">
                <i class="fas fa-sync-alt"></i> <span class="icon-text">Rafraîchir</span>
            </button>
            } else {
