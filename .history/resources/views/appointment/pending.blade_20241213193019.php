...
@section('header')
    ...
    const logo = "{{ App\Setting::get_option('logo') }}"; // Corrected to use the logo option

    const printWindow = window.open('', '_blank', 'width=600,height=400');
    printWindow.document.write('<html><head><title>Print</title>');
    printWindow.document.write('<style>img { max-width: 100%; height: auto; }</style>'); // Add style for logo
    ...
    printWindow.document.write('<img src="' + logo + '" alt="Logo" style="margin-bottom: 20px;">'); // Insert logo
    printWindow.document.write('<h3 style="text-align:center; margin:0;">Numéro</h3>');
    printWindow.document.write('<h1 style="text-align:center; font-size:xx-large; margin:10px 0;">' + num + '</h1>');
