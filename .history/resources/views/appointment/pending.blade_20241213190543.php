                    ...
                    @forelse($appointments as $appointment)
                        <tr>
                            ...
                            <td class="text-center">
                                @php
                                    function printAppointment($num) {
                                        return '<label class="badge badge-primary-soft">
                                                    <i class="fas fa-calendar"></i> ' . $num . '
                                                </label>
                                                <a href="' . route('appointment.print', ['num' => $num]) . '" target="_blank" title="Print PDF">
                                                    <i class="fas fa-file-pdf text-danger"></i>
                                                </a>';
                                    }
                                @endphp
                                {!! printAppointment($appointment->num) !!}
                            </td>
