...
function toggleActive(checkbox, appointmentId) {
    ...
    var label = checkbox.closest('.switch');
...
.switch {
    ...
    width: 30px; /* Adjusted width for a smaller switch */
    height: 15px; /* Adjusted height for a smaller switch */
}
...
.slider {
    ...
    right: 0;
    bottom: 0;
    background-color: #ccc; /* Gray color for the inactive state */
    transition: 0.4s;
    border-radius: 15px; /* Adjusted border radius for a smaller switch */
}

.slider:before {
    position: absolute;
    content: "";
    height: 13px; /* Adjusted height for a smaller switch */
    width: 13px; /* Adjusted width for a smaller switch */
    left: 1px; /* Adjusted position for a smaller switch */
    bottom: 1px; /* Adjusted position for a smaller switch */
...
input:checked + .slider {
    background-color: #007bff; /* Blue color for the active state */
}

input:checked + .slider:before {
    transform: translateX(15px); /* Adjusted translation for a smaller switch */
}

/* Optional styling for an active switch */
.switch.active .slider {
    box-shadow: 0 0 5px #007bff; /* Blue shadow for the active state */
}
