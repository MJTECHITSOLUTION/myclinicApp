                    ...
                    @forelse($appointments as $appointment)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="#" onclick="toggleActive('{{ $appointment->id }}'); this.classList.toggle('active');" title="Toggle Active" style="margin-left: 10px;">
                                <a href="#" onclick="toggleActive('{{ $appointment->id }}')" title="Toggle Active" style="margin-left: 10px;">
                                    <i class="fas fa-toggle-on {{ $appointment->active ? 'text-success' : 'text-danger' }}"></i>
                                </a>
...
@section('header')
    ...
    printWindow.print();
        ...
        function toggleActive(appointmentId) {
            // Get the current active status
            var currentStatus = {{ $appointment->active }};
