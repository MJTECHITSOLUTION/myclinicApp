...
$(document).ready(function () {
    ...
    $('#statusfilter').on('change', function () {
        ...
        $('#mytable tbody tr').each(function () {
            ...
            const statusCell = $(this).find('td:nth-child(5) label');

            if (statusCell.length) {
                // Get the status text (or value) from the cell
                const statusText = statusCell.text().trim();

                // Check if the row matches the selected status or if "All" is selected
