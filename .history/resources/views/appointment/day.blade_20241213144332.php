            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="form-group">
                        <label for="statusfilter" class="font-weight-bold">{{ __('sentence.Select Status') }}</label>
                        <select class="form-control" id="statusfilter" name="statusfilter" aria-label="{{ __('sentence.Select Status') }}">
                            <option value="">{{ __('sentence.All Statuses') }}</option>
                            <option value="1">{{ __('sentence.Terminé') }}</option>
                    <br>

                    <select class="form-control" name="statusfilter" aria-label="{{ __('sentence.Select Status') }}">
                        <option value="">{{ __('sentence.All Statuses') }}</option>
                        <option value="1">{{ __('sentence.Terminé') }}</option>
