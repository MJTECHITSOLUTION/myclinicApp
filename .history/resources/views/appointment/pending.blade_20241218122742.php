        ...
        <div class="card-header py-3">
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    @endcan
                    <form action="{{ route('appointment.searchByDate') }}" method="GET" class="float-right ml-2 mb-1 d-flex align-items-center">

                    <form action="{{ route('appointment.searchByDate') }}" method="GET" class="float-right ml-2 mb-1">
                        ...
                        <button type="submit" class="btn btn-info btn-sm ml-2" title="Rechercher par date">
                            <i class="fa fa-search"></i> <span class="icon-text">Rechercher</span>
                        </button>
                    </form>
                    ...
                    @forelse($appointments as $appointment)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                data-rdv_id="{{ $appointment->appointment_id }}"
                                data-patient_name="{{ $appointment->User->name }}"
                                data-waiting_list_id="{{ $appointment->id }}"
        ...
        function showOptionsPopup(appointmentId) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '{{ route("appointment.updateWaiting") }}', // Update with your route
                        type: 'POST',
                        data: {
