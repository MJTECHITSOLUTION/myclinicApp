                    ...
                    @forelse($appointments as $appointment)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="#" onclick="toggleActive('{{ $appointment->id }}', {{ $appointment->active }})" title="Toggle Active" style="margin-left: 10px;">
                                    <i class="fas fa-toggle-on {{ $appointment->active ? 'text-success' : 'text-danger' }}"></i>
                                </a>
                                <span class="icon-text">{{ $appointment->active ? __('sentence.Active') : __('sentence.Inactive') }}</span>
                            </td>
                            <td class="text-center">
