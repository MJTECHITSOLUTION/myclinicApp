                    ...
                    @forelse($appointments as $appointment)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="#" onclick="printValue('{{ $appointment->num }}')" title="Print">
...
@section('header')
    ...
    <script>
        function printValue(num) {
            ...
            printWindow.document.write('<h3 style="text-align:center">Numéro</h3>');
            printWindow.document.write('<h1 style="text-align:center">' + num + '</h1>');
            printWindow.document.write("<p style="font-size:small;">Docteur : {{ App\Setting::get_option(\'title\') }}<br>");
            printWindow.document.write("Adresse : {{ App\Setting::get_option(\'address\') }}, {{ App\Setting::get_option(\'ville\') }}, {{ App\Setting::get_option(\'phone\') }}.</p>');
