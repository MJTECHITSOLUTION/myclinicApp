...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                <div class="col-4">
                    <h6 class="m-0 font-weight-bold text-primary w-75 p-2">Archive du {{ \Carbon\Carbon::parse($date)->locale('fr')->translatedFormat('d F Y') }} </h6>
                ...
                <div class="col-8">
                    ...
                    <form action="{{ route('appointment.searchByDate') }}" method="GET" class="float-right ml-2 mb-1 d-flex align-items-center">
                        <input type="date" name="date" class="form-control form-control-sm d-inline-block" value="{{$date}}" required>
