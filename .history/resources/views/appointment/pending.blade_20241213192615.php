...
@section('header')
    ...
    printWindow.document.write('<h3 style="text-align:center; margin-top:50px;">Numéro</h3>');
    printWindow.document.write('<h1 style="text-align:center; margin-bottom:50px;">' + num + '</h1>');
