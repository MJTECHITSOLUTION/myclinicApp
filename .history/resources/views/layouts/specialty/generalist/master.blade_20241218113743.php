                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <div class="dropdown" >
                                ...
                                <div class="dropdown-menu" aria-labelledby="nestedDropdownMessages">
                                        <a class="collapse-item"
                                           href="{{ route('notifies.index') }}">Créer un message</a>
                                        <a class="collapse-item"
                                           href="{{ route('notifies.index') }}">Tous les messages</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="dropdown-menu dropdown-menu-right p-3" aria-labelledby="notifyDropdown" style="min-width: 300px;">
                                    <div class="predefined-messages mb-3">
                                        @foreach($notifies as $notify)
                                            @if($notify->active == 1) <!-- Changed condition to check for active = 1 -->
                                                <form action="{{ route('send.notify') }}" method="get">
                                                    @csrf
                                                    <input type="hidden" name="message" value="{{ $notify->name }}">
                                                    <button type="submit" class="btn btn-outline-primary btn-sm mb-2 w-100">{{ $notify->name }}</button>
                                                </form>
                                            @endif
                                        @endforeach
                                    </div>
