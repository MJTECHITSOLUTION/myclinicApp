        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div id="notificationCard" class="card" style="display: none; position: fixed; bottom: 70px; right: 20px; width: 300px;">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div class="card-header" style="background-color: #007bff; color: white; text-align: center; padding: 10px; border-radius: 5px 5px 0 0; flex-grow: 1;">
                        Salle d'attente
                    </div>
                    <button class="close" onclick="toggleNotificationCard()" style="border: none; background: none; cursor: pointer; font-size: 0.8em;">
