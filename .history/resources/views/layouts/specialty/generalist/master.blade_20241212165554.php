...
<div id="app">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @php
                $salle_soin = \App\Appointment::whereDate('date', today())
                    ->where('visited', 4)
            ...
            @isset($salle_soin)
                <div class="col-auto d-xl-block d-none">
                    <div class="header_notification d-flex align-items-center notification-wrapper" style="background-color: #f0f0f0; border-radius: 10px; padding: 10px;">
                        ...
                        <p class="notification_text mb-0" style="margin-left: 10px;"> <!-- Added margin-left for spacing -->
                        <p class="notification_text mb-0">
