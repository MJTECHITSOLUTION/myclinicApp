...
Route::get('/notifies/create', 'NotifyController@create')->name('notifies.create');
Route::post('/notifies', 'NotifyController@store')->name('notifies.store');
Route::get('/notifies/{id}/edit', 'NotifyController@edit')->name('notifies.edit');
Route::put('/notifies/{id}', 'NotifyController@update')->name('notifies.update');
