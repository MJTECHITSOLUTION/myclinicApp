...
Route::get('/notifies', ['index'])->name('notifies.index');
Route::get('/notifies/create', ['create'])->name('notifies.create');
Route::post('/notifies', ['store'])->name('notifies.store');
Route::get('/notifies/{id}/edit', [NotifyController::class, 'edit'])->name('notifies.edit');
Route::put('/notifies/{id}', [NotifyController::class, 'update'])->name('notifies.update');
Route::delete('/notifies/{id}', [NotifyController::class, 'destroy'])->name('notifies.destroy');