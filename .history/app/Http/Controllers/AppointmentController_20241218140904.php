...
class AppointmentController extends Controller
{
	...
	public function store(Request $request){
        ...
        return $request->status == 3 
            ...
            : Redirect::route('appointment.day')->with('success', 'Rendez-vous créé avec succès !');
	}
    ...
    public function store_edit(Request $request)
    {
        ...
        if($request->wating_list_id){
            $waitingList = Waiting_list::findOrFail($request->wating_list_id);
            $waitingList->status = 1; // Change the status to 1
            $waitingList->save(); // Save the changes
        }
    ...
    public function pending(){
        ...
        $appointments = Waiting_list::orderBy('num', 'ASC')->where('status','=',3)->paginate(10);
    ...
    public function day(){
        ...
        $appointments = Appointment::whereDate('date', $currentDate)->orderBy('id','ASC')->paginate(10);
...
public function updateActiveStatus($id)
{
    ...
    $appointment = Waiting_list::findOrFail($id);
...
public function searchByDate(Request $request)
{
    ...
    $appointments = Waiting_list_archive::whereDate('created_at', $date)->get();

    return view('appointment.archive', compact('appointments','date'));
}
