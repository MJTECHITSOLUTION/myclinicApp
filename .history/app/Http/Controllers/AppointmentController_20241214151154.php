...
class AppointmentController extends Controller
{
	...
	public function store(Request $request){
        ...
        if ($request->status == 3) {
            return Redirect::route('appointment.pending')->with('success', 'Rendez-vous créé avec succès !');
        } else {
        
		return Redirect::route('appointment.day')->with('success', 'Rendez-vous créé avec succès !');
